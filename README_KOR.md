...
서버 내부적인 오류로 인해서 임시로 데이터셋 홈페이지가 다음의 주소로 변경되었습니다. [https://www.thebackend.io/research-backend-ts](https://www.thebackend.io/research-backend-ts). 데이터셋 다운로드는 [https://drive.google.com/drive/folders/12NBfJk3pRqEDsjDXglt12BpAVIK_Fzp9?usp=sharing](https://drive.google.com/drive/folders/12NBfJk3pRqEDsjDXglt12BpAVIK_Fzp9?usp=sharing)에서 가능합니다.
